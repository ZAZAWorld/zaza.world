<div class='ad_filter_row'>
    ...
    <div class='col-md-10 m-50'>
        <div class='col-md-100 ad_filter_col m-100'>
            {{  Form::select('type_transport_id', array(Null=>TransWord::getArabic('Type motorbike', false)) + $ar_type_transport, (Input::has('type_transport_id') ? Input::get('type_transport_id') : null), array('class'=>'ad_filter_input',  'id'=>'type_transport_id')) }}
        </div>
    </div>
    <div class='col-md-20 ad_filter_col'>
...
<div class='ad_filter_row'>
    ...
    <div class='col-md-10 ad_filter_col m-25'>
        ...
        <div class='ad_filter_col__body'>
            {{  Form::select('car_transmiss_id', array(Null=>TransWord::getArabic('', false)) + $ar_transmission, (Input::has('car_transmiss_id') ? Input::get('car_transmiss_id') : null), array('class'=>'ad_filter_input', 'id'=>'car_transmiss_id')) }}
        </div>
    </div>
    ...
    <div class='col-md-10 ad_filter_col m-25'>
        ...
        <div class='ad_filter_col__body'>
            {{  Form::select('car_warranty_id', array(Null=>TransWord::getArabic('', false)) + $ar_warranty, (Input::has('car_warranty_id') ? Input::get('car_warranty_id') : null), array('class'=>'ad_filter_input', 'id'=>'car_warranty_id')) }}
        </div>
    ...
    <div class='col-md-10 ad_filter_col ad_filter_col--border m-25'>
        ...
        <div class='ad_filter_col__body'>
            {{  Form::select('car_condition_id', array(Null=>TransWord::getArabic('', false)) + $ar_condition, (Input::has('car_condition_id') ? Input::get('car_condition_id') : null), array('class'=>'ad_filter_input', 'id'=>'car_condition_id')) }}
        </div>
    </div>
