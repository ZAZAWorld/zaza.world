<div class='ad_filter_row'>
    ...
    <div class='col-md-20 m-50'>
        <div class='col-md-100 ad_filter_col m-100'>
            {{  Form::select('type_transport_id', array(Null=>TransWord::getArabic('Type truck', false)) + $ar_type_transport, (Input::has('type_transport_id') ? Input::get('type_transport_id') : null), array('class'=>'ad_filter_input',  'id'=>'type_transport_id')) }}
        </div>
    </div>
    <div class='col-md-20 ad_filter_col'>
