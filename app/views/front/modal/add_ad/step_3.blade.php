...
<div class="add_ad_vip">
	...
	<div class="add_ad_vip__body">
		<div class="add_ad_vip_block">
			<!---- green block ------------>
			<div class="add_ad_vip_block__item add_ad_vip_block__item_grey js-vip-option"  id='add_ad_vip_block__1' data-sum='0' data-val_selector='js_add_advert_is_green'>
				...
				<div class="add_ad_vip_block__check">
					<span class="icon-32 js-check_vip">&nbsp;</span>
				</div>
			...
			<!---- sale block ------------>
			<div class="add_ad_vip_block__item add_ad_vip_block__item_grey js-vip-option"  id='add_ad_vip_block__2' data-sum='0' data-val_selector='js_add_advert_is_sale'>
				<div class="add_ad_vip_block__price"><strike>{{TransWord::getArabic('AED')}} 7</strike> <br />{{TransWord::getArabic('FREE')}}</div>
				<div class="add_ad_vip_block__price-back">&nbsp;</div>
				<div class="add_ad_vip_block__check">
					<span class="icon-32 js-check_vip">&nbsp;</span>
				...
				<div class="add_ad_vip_block__bottom">
					<div class="add_ad_vip_block__bottom_line">
						...
						<div class="col-md-70">
							<input type='text' name='advert_pay[price_was]' class="idiot_price_format js-add-ad-price-value add_ad_vip_block__input js-add-ad-price-value3333"  value="100"/>
						 </div>
					</div>
					<div class="add_ad_vip_block__bottom_line">
						<div class="col-md-25 add_ad_vip_block__input_label"> {{TransWord::getArabic('now')}} </div>
						<div class="col-md-70">
							<input type='text' name='advert_pay[price_now]' class="idiot_price_format add_ad_vip_block__input js-add-ad-price-value4444" value="100"/>
						 </div>
					</div>
				</div>
			</div>
		...
		<div class="add_ad_vip_block">
			...
			<div class="add_ad_vip_block__item add_ad_vip_block__item_grey js-vip-option"  id='add_ad_vip_block__3' data-sum='0' data-val_selector='js_add_advert_is_hot_or_urgent'>
				<div class="add_ad_vip_block__price"><strike>{{TransWord::getArabic('AED')}} 7</strike> <br />{{TransWord::getArabic('FREE')}}</div>
				<div class="add_ad_vip_block__price-back">&nbsp;</div>
				<div class="add_ad_vip_block__check">
				...
				<div class="add_ad_vip_block__bottom">
					<div class="add_ad_vip_block__bottom_line">
						<div class="col-md-50 add_ad_vip_block__input_check">
							<span class="icon-32 js-add_ad_hot_deal_click"  style='font-size: 16px;
						...
						<div class="col-md-50 add_ad_vip_block__input_check">
							<span class="icon-32 js-add_ad_urgent_click" style='font-size: 16px;
																		display: inline-block;
																		width: 14px;
																		position: relative;
																		top: 3px;
			...
			<!---- vip block ---------->
			<div class="add_ad_vip_block__item add_ad_vip_block__item_grey js-vip-option"  id='add_ad_vip_block__4' data-sum='0' data-val_selector='js_add_advert_is_vip'>
				<div class="add_ad_vip_block__check">
					<span class="icon-32 js-check_vip">&nbsp;</span>
				</div>
				<div class="add_ad_vip_block__body">
				...
				<div class="add_ad_vip_block__bottom">
					...
					<div class="add_ad_vip_block__bottom_line">
						<div class="col-md-45">
							<input name='advert_pay[vip_count]' type='number' class="add_ad_vip_block__input js-vip_view-input" placeholder="100" min='100' />
	...
	<div class="row">
		...
		<div class="col-md-45">
			<button class="add_ad_buttons__before js-add_ad_step" data-step='2' data-before-step='3' type='button' style='    margin-top: 10px !important;'>
		...
		<div class="col-md-45">
			<button class="add_ad_vip_block__submit close" type='button'>
	...
	<input type='hidden' name='advert_pay[is_green]' value='0' class='js_add_advert_is_green' />
	<input type='hidden' name='advert_pay[is_sale]' value='0' class='js_add_advert_is_sale' />
	<input type='hidden' name='advert_pay[is_hot_or_urgent]' value='0' class='js_add_advert_is_hot_or_urgent' />
	<input type='hidden' name='advert_pay[is_vip]' value='0' class='js_add_advert_is_vip' />
	
	<input type='hidden' name='advert_pay[is_hot]' value='0' class='js_add_advert_is_hot' />
	<input type='hidden' name='advert_pay[is_urgent]' value='0' class='js_add_advert_is_urgent' />
