		   ...
		   <div class="c-postauthor">
			   <div class="c-postauthor__inner">
					<a href='{{ action("PersonController@getView",  $b->user_id) }}'>
					   <div class="c-postauthor__image" style="background: url('{{ $b->relUser->getPhoto(); }}') no-repeat center; background-size: auto 100%;" data-id="{{ $b->id }}"></div>
				   ...
				   <div class="l-grid-noGutter-middle_sm-1">
					   ...
					   <div class="l-grid__col-6_xs-5">
						   <div class="c-post__share">
								<a href="#edit" class="c-postshare js-call-blog-update-blog" data-id="{{ $b->id }}">
								   <span class="c-postshare__edit"><img src="/front/img/icons/pencil.png" width="12"></span>
								</a> &nbsp; 
								...
								<div class='mess_block ok shadow' id='confirmDelete' style="display: none;">
									...
									<div class='mess_footer'>
										<a href="{{ action('BlogController@getDelete', $b->id) }}" class="mess_confirm__delete " style="border: 0;color: #fff;border-radius: 5px;padding: 5px 15px;font-size: 1.2em;font-weight: 600;background: #8bc34a;margin-bottom: 3px;">Yes</a>
								...
								<!-- <a href="{{ action('BlogController@getDelete', $b->id) }}" class="c-postshare">
								   <span class="c-postshare__edit">✖</span>
								</a> -->
						   </div>
					   </div>
				   </div>
