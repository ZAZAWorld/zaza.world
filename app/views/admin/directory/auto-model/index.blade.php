    ...
    <div class="col-md-12">
        <div class="box">
			...
			<div style="float:right;width:30%;padding: 10px;">
                <form action="{{ action('AdminAutoModelController@getIndex') }}" class="c-reviews-form" method='get' >
                ...
                <table class="table table-bordered">
                    <tbody>
                        <tr>
                            ...
                            <th><a href="?sort_name=brands&sort_val={{
								(Input::has('sort_name') && Input::get('sort_name') == 'brands') && 
								Input::get('sort_val') == 'down' ? 'up' : 'down'
							}}">Brand</a></th>
                            <th style="width: 40px">
                                <a href='{{ action("AdminAutoModelController@getItem") }}'>Add new</a>
                            </th>
                        </tr>
                        @foreach ($items as $i)
                            <tr>
                                ...
                                <td>
                                    <div class="dropdown">
										...
										<ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
											<li><a href='{{ action('AdminAutoModelController@getItem', array($i->id)) }}'>Edit</a></li>
											<li><a href='{{ action('AdminAutoModelController@getDelete', array($i->id)) }}'>Delete</a></li>
										</ul>
									</div>
                                </td>
                            </tr>
